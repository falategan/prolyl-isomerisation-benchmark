...
This section makes use of the initial optimised geometry generate in the section [### Preparation of the starting geometry](./README.md### Preparation of the starting geometry) above.
